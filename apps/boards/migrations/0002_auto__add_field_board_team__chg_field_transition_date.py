...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Board.team'
        db.add_column(u'boards_board', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Transition.date'
        db.alter_column(u'boards_transition', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Board.team'
        db.delete_column(u'boards_board', 'team_id')


        # Changing field 'Transition.date'
        db.alter_column(u'boards_transition', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
