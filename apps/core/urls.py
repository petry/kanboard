...
from apps.core.views import BoardDetailView, StoryDetailView, BoardListView, StoryOnBoardView
...
urlpatterns = patterns('',
    ...
    url(r'^story/(?P<pk>\d+)/onboard/$', StoryOnBoardView.as_view(), name='story-onboard'),
)
