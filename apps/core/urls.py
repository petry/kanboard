...
from apps.core.views import BoardDetailView, StoryDetailView, BoardListView, StoryAdvanceView
...
urlpatterns = patterns('',
    ...
    url(r'^story/(?P<pk>\d+)/advance/$', StoryAdvanceView.as_view(), name='story-advance'),
)